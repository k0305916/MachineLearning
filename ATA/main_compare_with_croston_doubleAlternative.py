...
def fit_ata(
        ...
        if list(nzd) != [0]:
                ...
                try:
                    ...
                    # # plt.plot(EGlobe)
                    # # plt.scatter(EGlobe.index(min(EGlobe)), min(EGlobe))
                    # # print(EGlobe.index(min(EGlobe)), min(EGlobe))
                    # # plt.show()
                    ...
                    # ata_mse = [w_opt_p[0][0], w_opt_q[0][0]]
                    ata_mse = w_opt[0]
...
def _ata_cost(
    ...
    # w_len = len(p0)
    # if w_len == 1:
    #     E = np.array([None] * input_series_length)
    #     frc_in = _ata(
    #                 input_series = input_series,
    ...
    #                 h=0,
    #                 epsilon = epsilon
    #                     )['model']['demand_series'].values

    #     k=1
    #     for i in range(input_series_length):
    #         E[i] = (frc_in[i] - input_series[i]*k)
    #         if input_series[i] == 0:
    #             k = k + 1
    #         else:
    #             k = 1
    ...
    #                 h=0,
    #                 epsilon = epsilon
    #                     )['model']['interval_series'].values


    #     k=1
    #     intervalVec = []
    #     for i in range(input_series_length):
    #         intervalVec.append(k)
    #         if input_series[i] == 0:
    #             k = k + 1
    #         else:
    #             k = 1

    #     E = intervalVec - frc_in
    #     E = E[E != np.array(None)]
    #     E = np.sqrt(np.mean(E ** 2))
