...
for i in range(cv_count):
    ...
    MSE = _ata_cost((opt_model["a_demand"], opt_model["a_interval"]), test_data, len(test_data), 1e-7)
...
# round 1: output P: 4756.0        Q: 2883.0       mse: 6695938.521213064
# round 2: 
